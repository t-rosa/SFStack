...
const TagGroup = ({ children, ...props }: TagGroupProps) => {
    return (
        <TagGroupPrimitive
            {...props}
            className={twMerge("flex flex-col flex-wrap gap-1", props.className)}
        >
                        ...
                        {allowsRemoving && (
                            <Button
                                ...
                                className={cr("", (className) => {
                                    return twMerge(
                                        "-mr-0.5 grid size-3.5 place-content-center rounded focus:outline-none focus-visible:ring-1 focus-visible:ring-primary",
                                        className,
                                    );
                                })}
                            >
