...
const Layout = ({
    ...
    return (
        <div className={layout({ className })}>
            ...
            <main className="flex flex-1 flex-col pt-12 lg:min-w-0 lg:pt-0">
                        ...
                        <>
                            {collapsible ?
                                <ButtonPrimitive
                                    slot="trigger"
                                    className={twJoin(
                                        "flex w-full items-center justify-between px-3 py-2 text-sm text-muted-fg has-[.idctr]:pr-0 focus:outline-none [&>.idctr]:size-6 [&>.idctr]:duration-200",
